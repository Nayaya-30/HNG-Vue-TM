<template>
	<div class="p-8 rounded-2xl shadow-lg bg-gray-800">
		<h3 class="text-2xl font-bold mb-4 text-white">Quick Actions</h3>
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
			<button
				@click="$router.push('/tickets')"
				class="flex flex-col items-center justify-center p-6 bg-blue-50 hover:bg-blue-100 rounded-xl transition-all group dark:bg-blue-900/30 dark:hover:bg-blue-900/50"
				>
			...
			<button
				@click="$router.push('/tickets')"
				class="flex flex-col items-center justify-center p-6 rounded-xl transition-all group bg-green-900/30 hover:bg-green-900/50"
				>
				...
				<span class="font-semibold text-white">Create Ticket</span>
			</button>

			<button
				class="flex flex-col items-center justify-center rounded-xl transition-all group bg-purple-900/30 hover:bg-purple-900/50"
				>
				...
				<span class="font-semibold text-white">View Reports</span>
			</button>

			<button
				class="flex flex-col items-center justify-center p-6 bg-yellow-50 hover:bg-yellow-100 rounded-xl transition-all group bg-yellow-900/30 hover:bg-yellow-900/50"
				>
