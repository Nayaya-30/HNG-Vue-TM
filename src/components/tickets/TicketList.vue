  ...
  <div>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-if="tickets.length === 0" class="col-span-full text-center py-12">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mb-2 dark:text-white">No tickets yet</h3>
        <p class="text-gray-600 mb-6 dark:text-gray-300">Create your first ticket to get started</p>
        <button
          @click="$emit('start-edit', null)"
          class="bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-blue-700 transition-all inline-flex items-center gap-2"
        >
